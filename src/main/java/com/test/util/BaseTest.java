...
public class BaseTest {
	...
	public BaseTest() {
		...
		if(PropertyLoader.getProperty(Constants.SERVER).equals("LOCAL")) {
			...
			String USERNAME = "alejandrocarmona4";
			  String AUTOMATE_KEY = "hadfxYmzvgeYRcpTPRKX";
			  String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
			  DesiredCapabilities caps = new DesiredCapabilities();
			  	caps.setCapability("build", PropertyLoader.getProperty(Constants.BUILD));
			  	caps.setCapability("project", PropertyLoader.getProperty(Constants.PROJECT));
